...
%%% 
%%% This was developed by Austin Downey for SEM-IMAC XL in 2022. 
%%% 
%%% Checked with: Texlive 2022, MikTex (updated 2021), Texlive 2019. 
...
% Adjust the font and style of title and autor section
\usepackage{etoolbox}
\makeatletter
...
\begin{document}
	\date{} % keeps the date frome being printed
	...
	\section{Introduction}
		...
		\begin{figure}
			\centering
			\includegraphics[width=2in]{figures/papernum_dow_Fig1.jpg}
