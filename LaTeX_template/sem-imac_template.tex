...
\title{\Large\textbf{\LaTeX\ PACKAGE FOR WRITING
PAPERS IN\\
...
IMAC \cite{Downey2020Millisecondmodelupdating}


\section{Introduction}

First thing to note is that the IMAC style indents the first 
...
IMAC\cite{Downey2020Millisecondmodelupdating} %notation convention (See Table \ref{dm}). If you use them, you can simply redefine the 
...
Please contact me at \verb*zjoseph.slater@wright.eduz if you find bugs in this. 
...
\verb*zjoseph.slater@wright.eduz.
